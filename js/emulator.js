...
class Emulator {
  ...
  async showHelp() {
    const lines = [
      ...
      'IF e THEN s ELSE s  With else branch',
      ...
      'RESUME        Continue after ONERR',
      'CLEAR / CLR   Clear all variables',
      'WAIT          Wait for hw (stub)',
      '',
      '--- SCREEN & TEXT ---',
      ...
      '',
      '--- OTHER FUNCTIONS ---',
      'FRE(n)        Free memory (returns 38911)',
      ...
      '',
      'DRIVE SELECT:  Add ,D1 or ,D2 to',
      '  CATALOG, SAVE, LOAD commands',
      '  e.g. CATALOG,D2 or LOAD X,D1',
      '',
      '--- FILE I/O ---',
      ...
      'STORE        Cassette save (stub)',
      'RECALL       Cassette load (stub)',
      '',
      '--- PRODOS / DIRECTORIES ---',
